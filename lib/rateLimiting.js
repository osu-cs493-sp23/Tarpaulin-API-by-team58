...
const { verifyAuthTokenExists } = require("./hateoasHelpers.js")

//rate limiting details
const RATE_LIMIT_WINDOW_MILLIS = 60000
const RATE_LIMIT_MAX_UNAUTHED_REQUESTS = 10
const RATE_LIMIT_MAX_AUTHED_REQUESTS = 30
/* const RATE_LIMIT_UNAUTHED_REFRESH_RATE = RATE_LIMIT_MAX_UNAUTHED_REQUESTS / RATE_LIMIT_WINDOW_MILLIS
const RATE_LIMIT_AUTHED_REFRESH_RATE = RATE_LIMIT_MAX_AUTHED_REQUESTS / RATE_LIMIT_WINDOW_MILLIS */
...
async function limitRate(req, res, next){
	...
	/* const userAuthed = verifyAuthTokenExists(req)
	const maxRequests = userAuthed ? 
		RATE_LIMIT_MAX_AUTHED_REQUESTS : RATE_LIMIT_MAX_UNAUTHED_REQUESTS
	const refreshRate = userAuthed ? 
		RATE_LIMIT_AUTHED_REFRESH_RATE : RATE_LIMIT_UNAUTHED_REFRESH_RATE */
